...
import 'package:live_crime_reporter/views/screen_classes_appbar.dart';
import 'package:live_crime_reporter/views/screen_classes_navigation.dart';
...
class AppTheme {
  // Primary colors
  static const Color primary = Colors.lightGreen; // Indigo
  static const Color primaryDark = Colors.green; // Dark Indigo
            ...
            Positioned(
              ...
              child: Row(
                children: [
                  ...
                  InkWell(
                    onTap: () {
                      // Navigate to offline nearby screen
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const NearbyOfflineScreen(),
                        ),
                      );
                    },
                    child: Container(
